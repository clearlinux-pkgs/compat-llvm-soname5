...
Source2 : http://releases.llvm.org/5.0.1/llvm-5.0.1.src.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-3-Clause MIT NCSA
Requires: compat-llvm-soname5-lib = %{version}-%{release}
Requires: compat-llvm-soname5-license = %{version}-%{release}
...
%package license
Summary: license components for the compat-llvm-soname5 package.
Group: Default

%description license
license components for the compat-llvm-soname5 package.


%prep
%setup -q -n llvm-5.0.1.src
cd ..
%setup -q -T -D -n llvm-5.0.1.src -b 1
mkdir -p tools/clang
cp -r %{_topdir}/BUILD/cfe-5.0.1.src/* %{_topdir}/BUILD/llvm-5.0.1.src/tools/clang
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567817603
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
export SOURCE_DATE_EPOCH=1567817603
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/compat-llvm-soname5
cp LICENSE.TXT %{buildroot}/usr/share/package-licenses/compat-llvm-soname5/LICENSE.TXT
cp test/YAMLParser/LICENSE.txt %{buildroot}/usr/share/package-licenses/compat-llvm-soname5/test_YAMLParser_LICENSE.txt
cp tools/clang/LICENSE.TXT %{buildroot}/usr/share/package-licenses/compat-llvm-soname5/tools_clang_LICENSE.TXT
cp tools/clang/tools/clang-format-vs/ClangFormat/license.txt %{buildroot}/usr/share/package-licenses/compat-llvm-soname5/tools_clang_tools_clang-format-vs_ClangFormat_license.txt
cp utils/unittest/googlemock/LICENSE.txt %{buildroot}/usr/share/package-licenses/compat-llvm-soname5/utils_unittest_googlemock_LICENSE.txt
cp utils/unittest/googletest/LICENSE.TXT %{buildroot}/usr/share/package-licenses/compat-llvm-soname5/utils_unittest_googletest_LICENSE.TXT
pushd clr-build
%make_install
popd
...
rm -f %{buildroot}/usr/bin/clang++
rm -f %{buildroot}/usr/bin/clang-5.0
...
rm -f %{buildroot}/usr/bin/llvm-dsymutil
...
rm -f %{buildroot}/usr/bin/llvm-mcmarkup
...
rm -f %{buildroot}/usr/include/clang/Analysis/AnalysisContext.h
...
rm -f %{buildroot}/usr/include/clang/Basic/VersionTuple.h
...
rm -f %{buildroot}/usr/include/clang/Sema/AttributeList.h
...
rm -f %{buildroot}/usr/include/clang/Sema/PrettyDeclStackTrace.h
...
rm -f %{buildroot}/usr/include/clang/StaticAnalyzer/Core/BugReporter/BugReporterVisitor.h
...
rm -f %{buildroot}/usr/include/clang/Tooling/Core/QualTypeNames.h
...
rm -f %{buildroot}/usr/include/llvm/Analysis/ObjectUtils.h
rm -f %{buildroot}/usr/include/llvm/Analysis/OptimizationDiagnosticInfo.h
...
rm -f %{buildroot}/usr/include/llvm/BinaryFormat/ELFRelocs/WebAssembly.def
...
rm -f %{buildroot}/usr/include/llvm/BinaryFormat/WasmRelocs/WebAssembly.def
...
rm -f %{buildroot}/usr/include/llvm/CodeGen/ExecutionDepsFix.h
...
rm -f %{buildroot}/usr/include/llvm/CodeGen/GlobalISel/GISelAccessor.h
...
rm -f %{buildroot}/usr/include/llvm/CodeGen/LiveIntervalAnalysis.h
...
rm -f %{buildroot}/usr/include/llvm/CodeGen/LiveStackAnalysis.h
...
rm -f %{buildroot}/usr/include/llvm/CodeGen/MachineValueType.h
...
rm -f %{buildroot}/usr/include/llvm/DebugInfo/CodeView/CVDebugRecord.h
...
rm -f %{buildroot}/usr/include/llvm/DebugInfo/CodeView/TypeName.h
rm -f %{buildroot}/usr/include/llvm/DebugInfo/CodeView/TypeRecord.h
rm -f %{buildroot}/usr/include/llvm/DebugInfo/CodeView/TypeRecordBuilder.h
rm -f %{buildroot}/usr/include/llvm/DebugInfo/CodeView/TypeRecordMapping.h
rm -f %{buildroot}/usr/include/llvm/DebugInfo/CodeView/TypeSerializer.h
...
rm -f %{buildroot}/usr/include/llvm/DebugInfo/CodeView/TypeTableBuilder.h
...
rm -f %{buildroot}/usr/include/llvm/DebugInfo/MSF/MSFStreamLayout.h
...
rm -f %{buildroot}/usr/include/llvm/DebugInfo/PDB/Native/PublicsStreamBuilder.h
...
rm -f %{buildroot}/usr/include/llvm/ExecutionEngine/ObjectMemoryBuffer.h
...
rm -f %{buildroot}/usr/include/llvm/IR/Attributes.gen
...
rm -f %{buildroot}/usr/include/llvm/IR/Intrinsics.gen
...
rm -f %{buildroot}/usr/include/llvm/Support/AMDGPUCodeObjectMetadata.h
...
rm -f %{buildroot}/usr/include/llvm/Support/CodeGenCWrappers.h
...
rm -f %{buildroot}/usr/include/llvm/Support/GCOV.h
...
rm -f %{buildroot}/usr/include/llvm/Target/CostTable.h
...
rm -f %{buildroot}/usr/include/llvm/Transforms/GCOVProfiler.h
...
rm -f %{buildroot}/usr/include/llvm/Transforms/InstrProfiling.h
rm -f %{buildroot}/usr/include/llvm/Transforms/Instrumentation.h
rm -f %{buildroot}/usr/include/llvm/Transforms/ObjCARC.h
rm -f %{buildroot}/usr/include/llvm/Transforms/PGOInstrumentation.h
rm -f %{buildroot}/usr/include/llvm/Transforms/SampleProfile.h
...
rm -f %{buildroot}/usr/include/llvm/Transforms/Utils/CmpInstAnalysis.h
...
rm -f %{buildroot}/usr/include/llvm/Transforms/Utils/SimplifyInstructions.h
...
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/__clang_cuda_builtin_vars.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/__clang_cuda_cmath.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/__clang_cuda_complex_builtins.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/__clang_cuda_intrinsics.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/__clang_cuda_math_forward_declares.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/__clang_cuda_runtime_wrapper.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/__stddef_max_align_t.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/__wmmintrin_aes.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/__wmmintrin_pclmul.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/adxintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/altivec.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/ammintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/arm_acle.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/arm_neon.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/armintr.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx2intrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512bwintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512cdintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512dqintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512erintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512fintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512ifmaintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512ifmavlintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512pfintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512vbmiintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512vbmivlintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512vlbwintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512vlcdintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512vldqintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512vlintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avx512vpopcntdqintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/avxintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/bmi2intrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/bmiintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/clflushoptintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/clzerointrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/cpuid.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/emmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/f16cintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/float.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/fma4intrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/fmaintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/fxsrintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/htmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/htmxlintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/ia32intrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/immintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/intrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/inttypes.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/iso646.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/limits.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/lwpintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/lzcntintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/mm3dnow.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/mm_malloc.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/mmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/msa.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/mwaitxintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/nmmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/opencl-c.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/pkuintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/pmmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/popcntintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/prfchwintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/rdseedintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/rtmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/s390intrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/shaintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/smmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/stdalign.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/stdarg.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/stdatomic.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/stdbool.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/stddef.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/stdint.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/stdnoreturn.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/tbmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/tgmath.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/tmmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/unwind.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/vadefs.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/varargs.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/vecintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/wmmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/x86intrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/xmmintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/xopintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/xsavecintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/xsaveintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/xsaveoptintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/xsavesintrin.h
rm -f %{buildroot}/usr/lib64/clang/5.0.1/include/xtestintrin.h
...
rm -f %{buildroot}/usr/lib64/libLLVMAMDGPUAsmParser.so
rm -f %{buildroot}/usr/lib64/libLLVMAMDGPUAsmPrinter.so
rm -f %{buildroot}/usr/lib64/libLLVMAMDGPUCodeGen.so
rm -f %{buildroot}/usr/lib64/libLLVMAMDGPUDesc.so
rm -f %{buildroot}/usr/lib64/libLLVMAMDGPUDisassembler.so
rm -f %{buildroot}/usr/lib64/libLLVMAMDGPUInfo.so
rm -f %{buildroot}/usr/lib64/libLLVMAMDGPUUtils.so
rm -f %{buildroot}/usr/lib64/libLLVMAnalysis.so
rm -f %{buildroot}/usr/lib64/libLLVMAsmParser.so
rm -f %{buildroot}/usr/lib64/libLLVMAsmPrinter.so
rm -f %{buildroot}/usr/lib64/libLLVMBPFAsmPrinter.so
rm -f %{buildroot}/usr/lib64/libLLVMBPFCodeGen.so
rm -f %{buildroot}/usr/lib64/libLLVMBPFDesc.so
rm -f %{buildroot}/usr/lib64/libLLVMBPFDisassembler.so
rm -f %{buildroot}/usr/lib64/libLLVMBPFInfo.so
rm -f %{buildroot}/usr/lib64/libLLVMBinaryFormat.so
rm -f %{buildroot}/usr/lib64/libLLVMBitReader.so
rm -f %{buildroot}/usr/lib64/libLLVMBitWriter.so
rm -f %{buildroot}/usr/lib64/libLLVMCodeGen.so
rm -f %{buildroot}/usr/lib64/libLLVMCore.so
rm -f %{buildroot}/usr/lib64/libLLVMCoroutines.so
rm -f %{buildroot}/usr/lib64/libLLVMCoverage.so
rm -f %{buildroot}/usr/lib64/libLLVMDebugInfoCodeView.so
rm -f %{buildroot}/usr/lib64/libLLVMDebugInfoDWARF.so
rm -f %{buildroot}/usr/lib64/libLLVMDebugInfoMSF.so
rm -f %{buildroot}/usr/lib64/libLLVMDebugInfoPDB.so
rm -f %{buildroot}/usr/lib64/libLLVMDemangle.so
rm -f %{buildroot}/usr/lib64/libLLVMDlltoolDriver.so
rm -f %{buildroot}/usr/lib64/libLLVMExecutionEngine.so
rm -f %{buildroot}/usr/lib64/libLLVMGlobalISel.so
rm -f %{buildroot}/usr/lib64/libLLVMIRReader.so
rm -f %{buildroot}/usr/lib64/libLLVMInstCombine.so
rm -f %{buildroot}/usr/lib64/libLLVMInstrumentation.so
rm -f %{buildroot}/usr/lib64/libLLVMInterpreter.so
rm -f %{buildroot}/usr/lib64/libLLVMLTO.so
rm -f %{buildroot}/usr/lib64/libLLVMLibDriver.so
rm -f %{buildroot}/usr/lib64/libLLVMLineEditor.so
rm -f %{buildroot}/usr/lib64/libLLVMLinker.so
rm -f %{buildroot}/usr/lib64/libLLVMMC.so
rm -f %{buildroot}/usr/lib64/libLLVMMCDisassembler.so
rm -f %{buildroot}/usr/lib64/libLLVMMCJIT.so
rm -f %{buildroot}/usr/lib64/libLLVMMCParser.so
rm -f %{buildroot}/usr/lib64/libLLVMMIRParser.so
rm -f %{buildroot}/usr/lib64/libLLVMNVPTXAsmPrinter.so
rm -f %{buildroot}/usr/lib64/libLLVMNVPTXCodeGen.so
rm -f %{buildroot}/usr/lib64/libLLVMNVPTXDesc.so
rm -f %{buildroot}/usr/lib64/libLLVMNVPTXInfo.so
rm -f %{buildroot}/usr/lib64/libLLVMObjCARCOpts.so
rm -f %{buildroot}/usr/lib64/libLLVMObject.so
rm -f %{buildroot}/usr/lib64/libLLVMObjectYAML.so
rm -f %{buildroot}/usr/lib64/libLLVMOption.so
rm -f %{buildroot}/usr/lib64/libLLVMOrcJIT.so
rm -f %{buildroot}/usr/lib64/libLLVMPasses.so
rm -f %{buildroot}/usr/lib64/libLLVMProfileData.so
rm -f %{buildroot}/usr/lib64/libLLVMRuntimeDyld.so
rm -f %{buildroot}/usr/lib64/libLLVMScalarOpts.so
rm -f %{buildroot}/usr/lib64/libLLVMSelectionDAG.so
rm -f %{buildroot}/usr/lib64/libLLVMSupport.so
rm -f %{buildroot}/usr/lib64/libLLVMSymbolize.so
rm -f %{buildroot}/usr/lib64/libLLVMTableGen.so
rm -f %{buildroot}/usr/lib64/libLLVMTarget.so
rm -f %{buildroot}/usr/lib64/libLLVMTransformUtils.so
rm -f %{buildroot}/usr/lib64/libLLVMVectorize.so
rm -f %{buildroot}/usr/lib64/libLLVMX86AsmParser.so
rm -f %{buildroot}/usr/lib64/libLLVMX86AsmPrinter.so
rm -f %{buildroot}/usr/lib64/libLLVMX86CodeGen.so
rm -f %{buildroot}/usr/lib64/libLLVMX86Desc.so
rm -f %{buildroot}/usr/lib64/libLLVMX86Disassembler.so
rm -f %{buildroot}/usr/lib64/libLLVMX86Info.so
rm -f %{buildroot}/usr/lib64/libLLVMX86Utils.so
rm -f %{buildroot}/usr/lib64/libLLVMXRay.so
rm -f %{buildroot}/usr/lib64/libLLVMipo.so
...
/usr/share/package-licenses/compat-llvm-soname5/LICENSE.TXT
/usr/share/package-licenses/compat-llvm-soname5/test_YAMLParser_LICENSE.txt
/usr/share/package-licenses/compat-llvm-soname5/tools_clang_LICENSE.TXT
/usr/share/package-licenses/compat-llvm-soname5/tools_clang_tools_clang-format-vs_ClangFormat_license.txt
/usr/share/package-licenses/compat-llvm-soname5/utils_unittest_googlemock_LICENSE.txt
/usr/share/package-licenses/compat-llvm-soname5/utils_unittest_googletest_LICENSE.TXT
